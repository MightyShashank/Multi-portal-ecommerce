...
export default function Home_page() {
    ...
    return (
        <div className="">
            ...
            <Landing_page_below_carousel/>
            <Landing_page_category_carousel/>
            <Landing_page_below_category_carousel/>
            <Landing_page_ad_display_below_below_category_carousel/>
            <Landing_page_below_ad/>
