...
product_data = {
    ...
    "smart-home": [
        ...
        ("Echo Dot (4th Gen)", "Amazon", "ED4G-001", []),
        ("Echo Show 8", "Amazon", "ES8-002", []),
        ("Echo Studio", "Amazon", "ES-003", []),

        # Google Smart Devices
        ("Google Nest Hub", "Google", "GNH-004", []),
        ("Google Nest Audio", "Google", "GNA-005", []),
        ("Google Nest Mini", "Google", "GNM-006", []),
        ("Nest Thermostat", "Google", "NT-007", []),
        ("Nest Learning Thermostat", "Google", "NLT-008", []),
        ("Nest Cam (Battery)", "Google", "NCB-009", []),

        # Philips Hue Devices
        ("Philips Hue White and Color Ambiance", "Philips", "HUE-010", []),
        ("Philips Hue Lightstrip Plus", "Philips", "HUE-LS011", []),
        ("Philips Hue Play Light Bar", "Philips", "HUE-PL012", []),

        # Ring Smart Devices
        ("Ring Video Doorbell 4", "Ring", "RVD-013", []),
        ("Ring Floodlight Cam", "Ring", "RFC-014", []),
        ("Ring Alarm Security Kit", "Ring", "RAK-015", []),

        # Wyze Smart Devices
        ("Wyze Cam v3", "Wyze", "WCV3-016", []),
        ("Wyze Bulb Color", "Wyze", "WBC-017", []),

        # Arlo Smart Devices
        ("Arlo Pro 4", "Arlo", "AP4-018", []),
        ("Arlo Essential Video Doorbell", "Arlo", "AEVD-019", []),

        # TP-Link Kasa Smart Devices
        ("TP-Link Kasa Smart Plug", "TP-Link", "KSP-020", []),
        ("TP-Link Kasa Smart Bulb", "TP-Link", "KSB-021", []),

        # Smart Locks
        ("August Smart Lock Pro", "August", "ASL-022", []),
        ("Yale Assure Lock SL", "Yale", "YALS-023", []),
        ("Eufy Security Smart Lock", "Eufy", "ESSL-024", []),

        # Eufy Smart Cameras
        ("EufyCam 2 Pro", "Eufy", "ECP-025", []),

        # Home Security Systems
        ("SimpliSafe Home Security System", "SimpliSafe", "SHS-026", []),

        # Lutron Smart Devices
        ("Lutron Caseta Wireless Dimmer", "Lutron", "LCD-027", []),

        # Ecobee Smart Devices
        ("Ecobee SmartThermostat", "Ecobee", "EST-028", []),
        ("Ecobee SmartCamera", "Ecobee", "ESC-029", []),

        # Blink Cameras
        ("Blink Outdoor Camera", "Blink", "BOC-030", []),
        ("Blink Mini", "Blink", "BM-031", []),

        # Sonos Smart Devices
        ("Sonos One (Gen 2)", "Sonos", "SO2-032", []),
        ("Sonos Arc Soundbar", "Sonos", "SAS-033", []),

        # Nanoleaf Smart Lights
        ("Nanoleaf Shapes Light Panels", "Nanoleaf", "NSLP-034", []),
        ("Nanoleaf Lines", "Nanoleaf", "NL-035", []),

        # WeMo Smart Devices
        ("WeMo Smart Plug", "WeMo", "WSP-036", []),
        ("WeMo Smart Dimmer", "WeMo", "WSD-037", []),

        # Logitech Smart Remote
        ("Logitech Harmony Elite", "Logitech", "LHE-038", []),

        # SwitchBot Smart Devices
        ("SwitchBot Smart Curtain", "SwitchBot", "SSC-039", []),
        ("SwitchBot Smart Plug", "SwitchBot", "SSP-040", []),

        # Meross Smart Devices
        ("Meross Smart Plug", "Meross", "MSP-041", []),
        ("Meross Smart Light Switch", "Meross", "MSLS-042", []),

        # Govee Smart Devices
        ("Govee Smart LED Light Strips", "Govee", "GSL-043", []),
        ("Govee Smart Table Lamp", "Govee", "GSTL-044", []),

        # Other Smart Devices
        ("Sengled Smart Bulb", "Sengled", "SSB-045", []),
        ("LIFX Smart Bulb", "LIFX", "LSB-046", []),
        ("Tado Smart AC Control", "Tado", "TSAC-047", []),
        ("Bosch Smart Home Controller", "Bosch", "BSHC-048", [])
    ]
...
with open('./fake_electronics_sellers.json', 'r') as f:
...
def generate_fake_product(category, subcategory, index_i):
    ...
    product_id = f"flipkart_{category}_{subcategory}_{index_i}"
    seller = find_seller_by_product(product_id)
...
with open("./fake_products_eletronics.json", "w") as f:
